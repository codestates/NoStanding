...
function initModels(sequelize) {
  ...
  var Category_has_Category_city = _Category_has_Category_city(
    sequelize,
    DataTypes,
  );
  ...
  Category_has_Category_city.belongsTo(Category, {
    as: 'category',
    foreignKey: 'category_id',
  });
  Category.hasMany(Category_has_Category_city, {
    as: 'Category_has_Category_cities',
    foreignKey: 'category_id',
  });
  Shop_has_Category.belongsTo(Category, {
    as: 'category',
    foreignKey: 'category_id',
  });
  Category.hasMany(Shop_has_Category, {
    as: 'Shop_has_Categories',
    foreignKey: 'category_id',
  });
  Category_has_Category_city.belongsTo(Category_city, {
    as: 'category_city',
    foreignKey: 'category_city_id',
  });
  Category_city.hasMany(Category_has_Category_city, {
    as: 'Category_has_Category_cities',
    foreignKey: 'category_city_id',
  });
  Shop_has_Category_city.belongsTo(Category_city, {
    as: 'category_city',
    foreignKey: 'category_city_id',
  });
  Category_city.hasMany(Shop_has_Category_city, {
    as: 'Shop_has_Category_cities',
    foreignKey: 'category_city_id',
  });
  ...
  Shop.hasMany(Shop_has_Category, {
    as: 'Shop_has_Categories',
    foreignKey: 'shop_id',
  });
  Shop_has_Category_city.belongsTo(Shop, { as: 'shop', foreignKey: 'shop_id' });
  Shop.hasMany(Shop_has_Category_city, {
    as: 'Shop_has_Category_cities',
    foreignKey: 'shop_id',
  });
